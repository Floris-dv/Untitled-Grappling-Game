...
public:
  ...
  void Add(const std::vector<Vertex> &verts, const AABB &boundingBox,
           const std::vector<unsigned int> &idxs,
           std::vector<Texture> &&m_Textures,
           const glm::vec3 &diff = glm::vec3(0.0f),
           const glm::vec3 &spec = glm::vec3(0.0f), bool m_UseTextures = true);
  void Add(const std::vector<Vertex> &verts, const AABB &boundingBox,
           const std::vector<unsigned int> &idxs,
