...
EditingCamera::EditingCamera(CameraOptions options, float aspectRatio, glm::vec3 position, glm::vec3 up, float yaw, float pitch) : Camera(CAMERA_TYPE_EDITING, options, aspectRatio, position, up, yaw, pitch)
{
}
...
void EditingCamera::ProcessKeyboard(Camera_Movement direction, float deltaTime)
{
